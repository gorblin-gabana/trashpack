  ...
  return (
    <>
      <div className="flex mb-2">
        <BackBtn />
        <h2 className="text-xl font-bold text-white mx-auto pr-7">Receive GOR</h2>
      </div>

      <div className="bg-neutral-700 border border-zinc-600 rounded-lg p-6 text-center">
        <div className="mb-6">
          <div className="size-28 bg-white rounded-lg mx-auto mb-4 flex items-center justify-center">
            <QrCode size={80} className="text-black" />
          </div>
          <p className="text-xs text-zinc-400 mb-2">Scan QR code to receive GOR</p>
        </div>
      ...
      <div className="mt-4 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
        <p className="text-xs text-yellow-400">
          ⚠️ Only send GOR tokens to this address. Sending other tokens may result in loss of funds.
        </p>
      </div>
    </>
  );
